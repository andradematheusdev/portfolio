...
export const Wellcome = () => {
  return (
    ...
    <section id="home" className="wellcome-section">
      <div className="flex flex-col flex-1 px-6 mt-16 lg:px-20 max-w-full">
        <div className="flex items-center flex-col mb-8">
          ...
          <p className="max-w-[720px] text-center my-16">
            Tenho 27 anos, estudo programação por contra própria, sou apaixonado por tecnologia e tenho muita facilidade para aprender coisas novas!          
          </p>
        </div>
